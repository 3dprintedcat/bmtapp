...
const BMTHeader = () =>{
    ...
    return(
    <header className="App-header" style={screenSize.xs ? {backgroundColor:token.colorPrimary, height:"7vh", position:"sticky", top:0,}:{backgroundColor:token.colorPrimary, height:"7vh", position:"sticky", top:0,}}>
